...
**[Hello-React-Front-End]** is a project that uses a React/Redux to fetch data from a Rails API and display greetings in different languages randomly.
...
🔭 Future Feature
- **[A user can fetch data from a Rails API and display greetings in different languages]**
...
Feel free to check the [issues page](https://github.com/yayaismaail/hello-react-front-end/issues/).
...
This project is [MIT](https://github.com/yayaismaail/hello-react-front-end/blob/development/LICENSE) licensed.
